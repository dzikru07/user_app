...
class GenderFormRegister extends StatefulWidget {
  GenderFormRegister(
      {required this.width,
  ...
  @override
  State<GenderFormRegister> createState() => _GenderFormRegisterState();
}

class _GenderFormRegisterState extends State<GenderFormRegister> {
  var userGender;
      ...
      child: DropdownButton<String>(
        ...
        hint: Text(
          widget.formData.state.jenisKelamin == 0
              ? "Jenis Kelamin"
              : widget.formData.state.jenisKelamin == 1
                  ? "Laki Laki"
                  : "Perempuan",
        ...
        onChanged: (String? value) {
          ...
          setState(() {
            userGender = value!;
            widget.formData.setGender(value == 'Laki - Laki' ? 1 : 2);
          });
        },
